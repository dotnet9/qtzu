...
const FESTIVALS = [
  ...
  { m: 2, d: 17, name: '春节', en: 'Spring Festival', emoji: '🧧', until: 5 },   // 2026 春节 2/17，持续 5 天
  { m: 3, d: 8, name: '妇女节', en: "Women's Day", emoji: '🌷' },
  { m: 4, d: 5, name: '清明节', en: 'Qingming', emoji: '🌿' },
  { m: 6, d: 1, name: '儿童节', en: "Children's Day", emoji: '🎈', until: 3 },
  { m: 6, d: 19, name: '端午节', en: 'Dragon Boat Festival', emoji: '🚣', until: 5 },
  { m: 9, d: 25, name: '中秋节', en: 'Mid-Autumn Festival', emoji: '🥮', until: 5 },
